                                    ...
                                    <form action="includes/adduser_submit" method="post" data-toggle="validator" id="registration">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="radio col-sm-12">
                                              <label><input type="radio" value="friend" name="phpro_has_friend">I have a friend that I would like to take lessons with.</label>
                                            </div>
                                            
                                            <div class="radio col-sm-12">
                                              <label><input type="radio" value="nofriend" name="phpro_has_friend">Please place me with someone at Piano Pathways to take partner lessons.</label>
                                            </div>
