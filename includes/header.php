<div class="container-fluid header">
    <h5 class="text-right">
        ...
        <a href="https://www.youtube.com/user/rbellelo"><i class="fa fa-youtube-play"></i></a>&nbsp;&nbsp;
            <?php
                ...
                {
                    echo '<span><a href="/login"><i class="fa fa-sign-in black"></i> login</a></span>';
                }
                else
                {
                    echo '<span><a href="/logout"> <i class="fa fa-sign-in black"></i> logout</a></span>';
                }
            ?>
    </h5>
    <div class="logo-wrap">
    ...
    <h6 class="text-center black"><a href="https://www.google.com/maps/place/9270+Siegen+Ln+%23304,+Baton+Rouge,+LA+70810/@30.3672887,-91.0751662,17z/data=!3m1!4b1!4m2!3m1!1s0x8626a53e88fc2d09:0xda2e043d4fe40d5d" target="blank"><i class="fa fa-map-marker"></i> 9270 Siegen Lane #304 Baton Rouge, LA 70810</a></h6>
    <br>
    <h4 class="text-center black"><a href="tel:225-767-0030"><i class="fa fa-phone"></i> &#40;225&#41; 767&#45;0030</a></h4>
    <br>
