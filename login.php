                                        ...
                                        if (isset($_SESSION["message"])){
                                            ...
                                            if($host == 'thepianopathway-rhroyston.rhcloud.com/login') {
                                                if (strpos($message,'Success') !== false) {
                                                    echo "<div class='alert alert-success alert-dismissible alert-auto'><button class='close btn-sm' data-dismiss='alert'><i class='fa fa-times'></i></button><strong><i class='fa fa-check'></i> $message</strong></div>";
                                                }
                                                if (strpos($message,'Error') !== false) {
                                                    echo "<div class='alert alert-danger alert-dismissible alert-auto'><button class='close btn-sm' data-dismiss='alert'><i class='fa fa-times'></i></button><strong><i class='fa fa-exclamation-triangle'></i> $message</strong></div>";
                                                }
                                                $message = NULL;
