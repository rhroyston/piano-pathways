        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <table class="table">
                    ...
                    <tr>
                        <td><a class="modalclass" href="<?php echo 'dbselectuser?id=' . htmlspecialchars($r['phpro_user_id']); ?>" data-toggle="modal" data-target="#myModal"><i class='fa fa-search-plus'></i></a></td>
