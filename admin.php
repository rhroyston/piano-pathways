        ...
        echo '<html lang="en">';
            ...
            echo '<div class="container">';
                ...
                echo '<div class="row">';
                    ...
                    echo '<div class="col-sm-4 adminwidth">';
                        echo '<div class="raised">';    
                        echo '<h4>&nbsp;&nbsp;<i class="fa fa-calendar-o"></i> Upcoming Events<span class="pull-right admin-small"><a class="modalclass black textshadowsm" href="#" data-toggle="modal" data-target="#myModal"><i class="fa fa-pencil-square-o"></i></a></span</h4>';
                        echo '<div class="adminscroll">';
                        echo '<table class="table">';
