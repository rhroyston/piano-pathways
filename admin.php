        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <table class="table">
                    ...
                    <tr>
                        <td><a href="#myModal" class="modalanchor" data-toggle="modal" data-load-remote="<?php echo 'http://thepianopathway-rhroyston.rhcloud.com/db?id=' . htmlspecialchars($r['phpro_user_id']); ?>" data-remote-target="#myModal .modal-content"><i class='fa fa-search-plus'></i></a></td>
